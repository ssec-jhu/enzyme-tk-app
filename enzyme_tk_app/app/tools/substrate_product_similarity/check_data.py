"""Data availability check for the substrate-product-similarity tool.
...
def check_data() -> list[str]:
    ...
    The substrate-product-similarity tool requires at least one reaction
    database CSV under ``data/reactions/``.
